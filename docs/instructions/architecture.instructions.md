...
- v0.6 task-first UI work should use the committed v0.5 baseline inventory in `docs/planning/v0.6.0-ui-inventory.json` and ADR 0008 as its parity checklist before moving, hiding, or deleting routes, actions, workflow states, or user-facing strings.
