...
- Personal Models UI may render navigation, cards, aggregate profile/vocabulary/base-model status, and user controls, but profile import/export/delete/activation and heavy profile reads remain worker/package-owned.
