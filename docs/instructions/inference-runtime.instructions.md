...
- As of pinned `onnxruntime-web@1.27.0`, browser training is not exposed through a public `TrainingSession`/training subpath; keep the spike as a metadata/API capability report and do not add fake training execution.
