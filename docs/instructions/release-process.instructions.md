...
- Patch releases such as v0.6.1 must not move earlier release tags/assets. Add patch-specific release notes/checklists, bump package metadata consistently, tag the corrected commit, publish new checksums/assets, verify production headers and the exact hotfix behavior, and keep unrelated open gates such as #255 explicit.
