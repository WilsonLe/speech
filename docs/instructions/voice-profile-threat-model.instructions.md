...
- If a future trainer is added, does it split by prompt identity, keep held-out prompts separate, and refuse automatic activation when regression gates fail?
